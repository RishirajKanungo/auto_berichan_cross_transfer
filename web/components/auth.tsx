...
type AuthUser = { name?: string | null; image?: string | null; id?: string };
type AuthState = { authEnabled: boolean; signedIn: boolean; user?: AuthUser };
...
function Bridge({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ authEnabled: true, signedIn: !!data?.user, user: data?.user ?? undefined }}>
      {children}
