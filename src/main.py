...
Usage:
    python -m src.main                    # paste team interactively
    python -m src.main team.txt           # load from file
    python -m src.main --code 12345678    # override trade code for this run
"""
...
def main() -> None:
    ...
    if errors:
        print(
            ...
            f"Run  python setup_auth.py  to set up credentials, "
            f"or edit your .env file.{Style.RESET_ALL}"
        )
        sys.exit(1)
